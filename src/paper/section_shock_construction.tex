...
In addition, Appendix \ref{sec:appendix_shock_construction} contains figure to visually examine the presence of residual autocorrelation.
The graph shows that there is significant autocorrelation present in ${\epsilon}_{\xi,t+1}$ when considering the first to third lag. This implies that the residuals do not resemble white noise in the VAR model. This is supported by the fact that there is a positive correlation between the residuals. As a consequence, the model might be misspecified.
