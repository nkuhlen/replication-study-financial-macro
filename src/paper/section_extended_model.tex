...
% Table \ref{tab:estimation} summarises the values of the calibrated parameters. For the estimated shocks, it indicates the prior distribution. Additionally, it shows the mode and the 95\% HPD-interval of the posterior distribution. The posterior distribution is obtained using the Metropolis-Hastings algorithm.
