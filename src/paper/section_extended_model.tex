...
Note that the prior distributions for the average price mark-up $\bar{\eta}$ and the average wage mark-up $\bar{\upsilon}$ are generalised beta distributions with support [1, 2].
