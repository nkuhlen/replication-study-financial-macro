...
varexo   
     eps_z ${\varepsilon_z}$ (long_name='Productivity shock')
     eps_zeta ${\varepsilon_{\zeta}}$ (long_name='Investment shock')
     eps_gamma ${\varepsilon_{\gamma}}$ (long_name='Intertemporal shock')
     eps_eta ${\varepsilon_{\eta}}$ (long_name='Price mark-up shock')
     eps_upsilon ${\varepsilon_{\upsilon}}$ (long_name='Wage mark-up shock')
     eps_G ${\varepsilon_{g}}$ (long_name='Government shock')
     eps_varsigma ${\varepsilon_{\varsigma}}$ (long_name='Interest policy shock')
     eps_xi ${\varepsilon_{\xi}}$ (long_name='Financial shock')
         ;

parameters betta ${\beta}$ (long_name='Discount factor')
        tau ${\tau}$ (long_name='Tax advantage')
        alppha ${\alpha}$ (long_name='Utility parameter')
        theta ${\theta}$ (long_name='Production technology')
        delta ${\delta}$ (long_name='Depreciation rate')
        xi_bar ${\bar \xi}$ (long_name='Enforcement parameter')
        BY_ratio ${(\bar b/(1+\bar r)/\bar Y}$ (long_name='Debt output ratio')
        G_bar ${\bar G}$ (long_name='Average gov. purchases')
        GY_ratio ${\frac{\bar G}{\bar Y}}$ (long_name='Average government spending share')
        siggma ${\sigma}$ (long_name='Utility parameter')
        epsilon ${\varepsilon}$ (long_name='Elasticity of labor')
        h ${\lambda}$ (long_name='Habit in consumption')
        omega ${\omega}$ (long_name='Wage adjustment')
        phi ${\phi}$ (long_name='Price adjustment cost')
        varrho ${\varrho}$ (long_name='Investment adjustment cost')
        psi ${\psi}$ (long_name='Capital utilization cost')
        kappa ${\kappa}$ (long_name='Equity payout cost')
        eta_bar ${\bar \eta}$ (long_name='Average price mark-up ')
        upsilon_bar ${\bar \upsilon}$ (long_name='average wage mark-up ')
        ...
        rho_eta ${\rho_{\eta}}$ (long_name='Price mark-up shock persistence')
        rho_upsilon ${\rho_{\upsilon}}$ (long_name='Wage mark-up shock persistence')
        ...
        rho_gz ${\rho_{Gz}}$ (long_name='Interaction prod-government')
        rho_R ${\rho_{R}}$ (long_name='Monetary policy')
        nu_1 ${\nu_{1}}$ (long_name='Monetary policy')
        nu_2 ${\nu_{2}}$ (long_name='Monetary policy')
        nu_3 ${\nu_{3}}$ (long_name='Monetary policy')
        ;
